...
-- Copiando estrutura do banco de dados para sys_sistemageral
DROP DATABASE IF EXISTS `sys_sistemageral`;
CREATE DATABASE IF NOT EXISTS `sys_sistemageral` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sys_sistemageral`;

-- Copiando estrutura para tabela sys_sistemageral.system_access_log
...
-- Copiando dados para a tabela sys_sistemageral.system_access_log: 74 rows
...
INSERT INTO `system_access_log` (`id`, `sessionid`, `login`, `login_time`, `logout_time`) VALUES
	...
	(63, 'undgdbfjmbvk8k3ol0hlnj7pb3', 'admin', '2018-12-16 09:41:22', '2018-12-16 09:49:18'),
	(64, 'ch0mvaa5ougj50vuovhikri40r', 'admin', '2018-12-16 09:49:25', NULL),
	(65, 'vvnbvv34mc7l89im1kmfftqm21', 'admin', '2018-12-16 11:09:21', NULL),
	(66, '2d3eov02ku4gklliu1a8i2rtb1', 'admin', '2018-12-17 10:19:47', '2018-12-17 10:19:57'),
	(67, 'hu58oiv4kal31jr4pdnpmf95oh', 'admin', '2018-12-17 10:58:06', '2018-12-17 10:58:40'),
	(68, 'qlbvuohr1om30cbm6ctnjtg52l', 'admin', '2018-12-17 11:02:36', NULL),
	(69, '6anknid1j83qq2pakivk9nn55q', 'admin', '2019-03-02 09:12:38', '2019-03-02 09:13:24'),
	(70, 'mtalsit22tv4b9fcps7q7u5eo2', 'admin', '2019-03-02 09:22:34', NULL),
	(71, '8vrlj4tbidta0p7t8s4u51o4op', 'admin', '2019-03-02 10:07:53', '2019-03-02 10:37:58'),
	(72, 'bhbjdjrsp2cknfijj69q0s94le', 'admin', '2019-03-02 10:40:10', '2019-03-02 10:46:56'),
	(73, 'o3mbkci8j8kppkdri84p3mfvrt', 'admin', '2019-03-02 11:09:20', '2019-03-02 12:32:23'),
	(74, 'qc8e4k8pc46ofebhjt11j5r00q', 'admin', '2019-03-02 12:40:34', '2019-03-02 12:40:47');
/*!40000 ALTER TABLE `system_access_log` ENABLE KEYS */;

-- Copiando estrutura para tabela sys_sistemageral.system_change_log
...
-- Copiando dados para a tabela sys_sistemageral.system_change_log: 0 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_document
...
-- Copiando dados para a tabela sys_sistemageral.system_document: 0 rows
DELETE FROM `system_document`;
/*!40000 ALTER TABLE `system_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `system_document` ENABLE KEYS */;

-- Copiando estrutura para tabela sys_sistemageral.system_document_category
...
-- Copiando dados para a tabela sys_sistemageral.system_document_category: 1 rows
DELETE FROM `system_document_category`;
...
-- Copiando estrutura para tabela sys_sistemageral.system_document_group
...
-- Copiando dados para a tabela sys_sistemageral.system_document_group: 0 rows
DELETE FROM `system_document_group`;
/*!40000 ALTER TABLE `system_document_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `system_document_group` ENABLE KEYS */;

-- Copiando estrutura para tabela sys_sistemageral.system_document_user
...
-- Copiando dados para a tabela sys_sistemageral.system_document_user: 0 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_group
...
-- Copiando dados para a tabela sys_sistemageral.system_group: 3 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_group_program
...
-- Copiando dados para a tabela sys_sistemageral.system_group_program: 67 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_message
...
-- Copiando dados para a tabela sys_sistemageral.system_message: 2 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_notification
...
-- Copiando dados para a tabela sys_sistemageral.system_notification: 0 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_preference
...
-- Copiando dados para a tabela sys_sistemageral.system_preference: 0 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_program
...
-- Copiando dados para a tabela sys_sistemageral.system_program: 46 rows
...
INSERT INTO `system_program` (`id`, `name`, `controller`) VALUES
	...
	(48, 'Lista de Animais', 'AnimaisList'),
	(47, 'Lista de Estoque', 'EstoqueList');
/*!40000 ALTER TABLE `system_program` ENABLE KEYS */;

-- Copiando estrutura para tabela sys_sistemageral.system_sql_log
...
-- Copiando dados para a tabela sys_sistemageral.system_sql_log: 0 rows
DELETE FROM `system_sql_log`;
/*!40000 ALTER TABLE `system_sql_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `system_sql_log` ENABLE KEYS */;

-- Copiando estrutura para tabela sys_sistemageral.system_unit
...
-- Copiando dados para a tabela sys_sistemageral.system_unit: 2 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_user
...
-- Copiando dados para a tabela sys_sistemageral.system_user: 3 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_user_group
...
-- Copiando dados para a tabela sys_sistemageral.system_user_group: 3 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_user_program
...
-- Copiando dados para a tabela sys_sistemageral.system_user_program: 1 rows
...
-- Copiando estrutura para tabela sys_sistemageral.system_user_unit
...
-- Copiando dados para a tabela sys_sistemageral.system_user_unit: 3 rows
