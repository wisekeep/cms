...
-- Copiando dados para a tabela sys_multioffice.system_access_log: 65 rows
...
-- Copiando dados para a tabela sys_multioffice.system_group_program: 67 rows
...
-- Copiando dados para a tabela sys_multioffice.system_program: 46 rows
