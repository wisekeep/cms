...
class UsuariosList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // $usuario_cpf    = new TDBUniqueSearch('usuario_cpf', 'multioffice', 'Usuarios', 'id', 'usuario_cpf');
        // $usuario_rg     = new TDBUniqueSearch('usuario_rg' ,'multioffice', 'Usuarios', 'id','usuario_rg');
        // $usuario_nome   = new TDBUniqueSearch('usuario_nome','multioffice', 'Usuarios', 'id','usuario_nome');
